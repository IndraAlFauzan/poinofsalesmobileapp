...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( _FetchProducts value)?  fetchProducts,TResult Function( _FilterProductsByCategory value)?  filterProductsByCategory,TResult Function( _SearchProducts value)?  searchProducts,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _FetchProducts() when fetchProducts != null:
return fetchProducts(_that);case _FilterProductsByCategory() when filterProductsByCategory != null:
return filterProductsByCategory(_that);case _SearchProducts() when searchProducts != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( _FetchProducts value)  fetchProducts,required TResult Function( _FilterProductsByCategory value)  filterProductsByCategory,required TResult Function( _SearchProducts value)  searchProducts,}){
final _that = this;
switch (_that) {
case _Started():
return started(_that);case _FetchProducts():
return fetchProducts(_that);case _FilterProductsByCategory():
return filterProductsByCategory(_that);case _SearchProducts():
return searchProducts(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( _FetchProducts value)?  fetchProducts,TResult? Function( _FilterProductsByCategory value)?  filterProductsByCategory,TResult? Function( _SearchProducts value)?  searchProducts,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _FetchProducts() when fetchProducts != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function()?  fetchProducts,TResult Function( int categoryId)?  filterProductsByCategory,TResult Function( String query)?  searchProducts,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _FetchProducts() when fetchProducts != null:
return fetchProducts();case _FilterProductsByCategory() when filterProductsByCategory != null:
return filterProductsByCategory(_that.categoryId);case _SearchProducts() when searchProducts != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function()  fetchProducts,required TResult Function( int categoryId)  filterProductsByCategory,required TResult Function( String query)  searchProducts,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _FetchProducts():
return fetchProducts();case _FilterProductsByCategory():
return filterProductsByCategory(_that.categoryId);case _SearchProducts():
return searchProducts(_that.query);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function()?  fetchProducts,TResult? Function( int categoryId)?  filterProductsByCategory,TResult? Function( String query)?  searchProducts,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _FetchProducts() when fetchProducts != null:
return fetchProducts();case _FilterProductsByCategory() when filterProductsByCategory != null:
...
class _FilterProductsByCategory implements ProductEvent {
  const _FilterProductsByCategory(this.categoryId);
...
_$FilterProductsByCategoryCopyWith<_FilterProductsByCategory> get copyWith => __$FilterProductsByCategoryCopyWithImpl<_FilterProductsByCategory>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FilterProductsByCategory&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId));
}
...
@override
String toString() {
  return 'ProductEvent.filterProductsByCategory(categoryId: $categoryId)';
}
...
/// @nodoc
abstract mixin class _$FilterProductsByCategoryCopyWith<$Res> implements $ProductEventCopyWith<$Res> {
  factory _$FilterProductsByCategoryCopyWith(_FilterProductsByCategory value, $Res Function(_FilterProductsByCategory) _then) = __$FilterProductsByCategoryCopyWithImpl;
@useResult
$Res call({
 int categoryId
});
...
/// @nodoc
class __$FilterProductsByCategoryCopyWithImpl<$Res>
    implements _$FilterProductsByCategoryCopyWith<$Res> {
  __$FilterProductsByCategoryCopyWithImpl(this._self, this._then);

  final _FilterProductsByCategory _self;
  final $Res Function(_FilterProductsByCategory) _then;

/// Create a copy of ProductEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? categoryId = null,}) {
  return _then(_FilterProductsByCategory(
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $ProductStateCopyWith<$Res> {
