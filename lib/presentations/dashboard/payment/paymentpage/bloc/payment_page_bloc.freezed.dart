...
return validateTableSelection(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( List<PendingTransaction> transactions)?  updateTransactions,TResult Function( String? tableNo)?  selectTable,TResult Function( PendingTransaction transaction)?  toggleTransactionSelection,TResult Function()?  clearSelections,TResult Function()?  validateTableSelection,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateTransactions() when updateTransactions != null:
...
return validateTableSelection();case _:
  return orElse();
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( List<PendingTransaction> transactions)?  updateTransactions,TResult? Function( String? tableNo)?  selectTable,TResult? Function( PendingTransaction transaction)?  toggleTransactionSelection,TResult? Function()?  clearSelections,TResult? Function()?  validateTableSelection,}) {final _that = this;
switch (_that) {
case _UpdateTransactions() when updateTransactions != null:
return updateTransactions(_that.transactions);case _SelectTable() when selectTable != null:
return selectTable(_that.tableNo);case _ToggleTransactionSelection() when toggleTransactionSelection != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( List<PendingTransaction> allTransactions,  String? selectedTableNo,  List<PendingTransaction> selectedTransactions,  List<String> availableTables)?  loaded,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loaded() when loaded != null:
return loaded(_that.allTransactions,_that.selectedTableNo,_that.selectedTransactions,_that.availableTables);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( List<PendingTransaction> allTransactions,  String? selectedTableNo,  List<PendingTransaction> selectedTransactions,  List<String> availableTables)  loaded,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( List<PendingTransaction> allTransactions,  String? selectedTableNo,  List<PendingTransaction> selectedTransactions,  List<String> availableTables)?  loaded,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loaded() when loaded != null:
return loaded(_that.allTransactions,_that.selectedTableNo,_that.selectedTransactions,_that.availableTables);case _:
...
class _Loaded implements PaymentPageState {
  const _Loaded({required final  List<PendingTransaction> allTransactions, this.selectedTableNo, final  List<PendingTransaction> selectedTransactions = const [], final  List<String> availableTables = const []}): _allTransactions = allTransactions,_selectedTransactions = selectedTransactions,_availableTables = availableTables;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._allTransactions, _allTransactions)&&(identical(other.selectedTableNo, selectedTableNo) || other.selectedTableNo == selectedTableNo)&&const DeepCollectionEquality().equals(other._selectedTransactions, _selectedTransactions)&&const DeepCollectionEquality().equals(other._availableTables, _availableTables));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_allTransactions),selectedTableNo,const DeepCollectionEquality().hash(_selectedTransactions),const DeepCollectionEquality().hash(_availableTables));

@override
String toString() {
  return 'PaymentPageState.loaded(allTransactions: $allTransactions, selectedTableNo: $selectedTableNo, selectedTransactions: $selectedTransactions, availableTables: $availableTables)';
}
...
@useResult
$Res call({
 List<PendingTransaction> allTransactions, String? selectedTableNo, List<PendingTransaction> selectedTransactions, List<String> availableTables
});
...
/// Create a copy of PaymentPageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? allTransactions = null,Object? selectedTableNo = freezed,Object? selectedTransactions = null,Object? availableTables = null,}) {
